    ...
    summary: {
      en: [
        ...
        { heading: "📝 DPIA — Data Protection Impact Assessment", concepts: [
          ...
          { title: "DPIA Steps (Summary)", text: "7 Steps: (1) Identify need (2) Describe processing (3) Consultation with stakeholders (4) Assess necessity and proportionality (5) Assess risks to individuals (6) Identify mitigation measures (7) Sign off and plan ongoing review. DPIA is NOT a one-time exercise." },
        ...
        { heading: "🔄 Responsible Innovation (RI) — Key Scholars", concepts: [
          { title: "Ethics as a Design Constraint", text: "Ethics should NOT be something you add at the end. It must SHAPE the system during design and development. Ethics is an INPUT to development, not an after-the-fact check. Responsibility is not a final checklist — it must be woven into every phase." },
          { title: "Responsibility Must Be:", text: "(1) CONTINUOUS — ask ethical questions throughout the entire project lifecycle. (2) PROACTIVE — don't wait for harm; foresee risks early using methods like pre-mortem analysis and horizon scanning. (3) COLLECTIVE — not just one coder; it involves developers, managers, users, affected groups, regulators, and organizations." },
          { title: "Jack Stilgoe’s 4 Dimensions of RI", text: "ANTICIPATION — Systematic thinking about what might happen. Techniques: horizon scanning, scenario building, pre-mortem analysis (imagine the project has FAILED and work backwards). REFLEXIVITY — Looking inward at your own motivations, biases, and embedded values. Awareness of the limits of your knowledge. INCLUSION — Engaging a wide set of stakeholders EARLY and THROUGHOUT the process, not just at the end. RESPONSIVENESS — Willingness to alter the project direction based on new knowledge or stakeholder values." },
          { title: "René von Schomberg’s RRI Definition", text: "Responsible Innovation is a transparent, interactive process where innovation must be: (1) ETHICALLY ACCEPTABLE, (2) SOCIALLY DESIRABLE, (3) SUSTAINABLE. He linked RRI to democratic values and societal challenges. This is the benchmark definition used in EU policy." },
          { title: "AREA Framework (UK EPSRC)", text: "ANTICIPATE — Think about longer-term social and political impacts. What could go wrong? Who might be harmed? REFLECT — Personal and methodological bias. Whose values are we embedding? Are we aware of limits? ENGAGE — Collective decision-making and communication with diverse stakeholders. ACT — Use insights from A, R, E to steer the project differently; be willing to halt if needed." }
        ]},
        { heading: "📐 Values, Norms, and Rules (VNR)", concepts: [
          { title: "Values", text: "General, abstract beliefs about what is important: Privacy, Accountability, Safety, Fairness, Dignity. They guide us but are not directly enforceable." },
          { title: "Norms", text: "Actionable guidelines derived from values. They translate 'high-level ethics' into expected behavior. Example: from the value 'Privacy' comes the norm 'Users must be informed about data collection'." },
          { title: "Rules", text: "Concrete, prescriptive, or legal requirements. They translate norms into enforceable specifications. Example: the norm 'inform users' becomes the rule 'comply with GDPR Article 13 (right to be informed)'." },
          { title: "VNR Example Chains", text: "PRIVACY: Value=Privacy → Norm=Inform users about data collection → Rule=GDPR Article 13. ACCOUNTABILITY: Value=Accountability → Norm=Traceability (logging) → Rule=ISO/IEC 25010 (software quality standard). SAFETY: Value=Safety → Norm=Risk Assessment → Rule=AI Act Article 9 (risk management system)." }
        ]},
        { heading: "🛡️ DPIA — Full 7-Step Process", concepts: [
          { title: "Step 1: Identify the Need", text: "Determine if a DPIA is required. Screening checklist: new technologies? Large-scale processing? Special category data? Automated decisions?" },
          { title: "Step 2: Describe the Processing", text: "What data? From whom? Why? How will it flow? Who has access? How long stored?" },
          { title: "Step 3: Consultation", text: "Seek views of data subjects or their representatives. Consult DPO and relevant stakeholders." },
          { title: "Step 4: Assess Necessity and Proportionality", text: "Is the processing NECESSARY? Is it PROPORTIONATE to the aim? Could you achieve the same goal with less data?" },
          { title: "Step 5: Assess Risks", text: "Identify risks to rights and freedoms of individuals. Assess likelihood and severity. Consider: physical harm, financial loss, discrimination, reputational damage." },
          { title: "Step 6: Identify Measures", text: "Technical and organizational measures to mitigate risks. Examples: encryption, pseudonymization, access controls, data minimization, staff training." },
          { title: "Step 7: Sign Off and Review", text: "Document everything. Get sign-off from relevant authority. Plan for ongoing review and monitoring. DPIA is NOT a one-time exercise." }
        ]},
        { heading: "🗺️ NIST AI Risk Management Framework", concepts: [
          { title: "MAP", text: "Identify the context and potential risks. Understand the AI system, its purposes, and its environment." },
          { title: "MEASURE", text: "Assess and analyze identified risks using appropriate metrics and methods." },
          { title: "MANAGE", text: "Prioritize risks and take action. Implement controls and mitigations." },
          { title: "GOVERN", text: "Create a risk-aware organizational culture. Establish policies, accountability structures, and continuous monitoring." }
        ]}
      ],
      tr: [
        { heading: "🛡️ Veri Koruma İlkeleri", concepts: [
          ...
          { title: "Doğruluk ve Güncellik", text: "Kişisel veriler doğru ve güncel tutulmalı; hatalı veriler düzeltilmeli veya silinmelidir." },
          { title: "Depolama Sınırlaması", text: "Veriler gerektiğinden uzun süre saklanmamalıdır." },
          { title: "Hesap Verebilirlik", text: "Veri sorumlusu sadece uyumlu olmakla kalmaz, uyumu belgelendirerek göstermek zorundadır." }
        ]},
        { heading: "🔒 Privacy by Design & Default", concepts: [
          { title: "Tasarımda Gizlilik (GDPR Md. 25)", text: "Veri koruma sonradan eklenmez; sistemin mimarisine en baştan gömülür." },
          { title: "Varsayılan Gizlilik", text: "Varsayılan ayarlar en gizlilik dostu olmalı; kullanıcı ek ayar yapmadan korunmalıdır." }
        ]},
        { heading: "📝 DPIA — Uygulama Odaklı", concepts: [
          { title: "Ne Zaman Zorunlu?", text: "Sistematik izleme, büyük ölçekli özel nitelikli veri işleme, önemli etkili otomatik kararlar ve yeni teknoloji kullanımında DPIA zorunludur." },
          { title: "7 Adım", text: "1) İhtiyacı belirle 2) İşlemeyi tanımla 3) Paydaş danışması 4) Gereklilik-orantılılık 5) Risk değerlendirmesi 6) Azaltma önlemleri 7) Onay ve sürekli gözden geçirme." },
          { title: "Adım 4 Kritik Noktaları", text: "Hukuki dayanak nedir? Amaç daha az veriyle sağlanabilir mi? Function creep nasıl önlenecek? Veri minimizasyonu nasıl garanti edilecek?" },
          { title: "Adım 5 Risk Matrisi", text: "Riskler olasılık (likelihood) ve etki şiddeti (severity) ile puanlanır; birey haklarına etkiler önceliklendirilir." },
          { title: "Adım 7 Residual High Risk", text: "Yüksek artık risk kalırsa işlemeye geçmeden önce denetim otoritesiyle ön danışma gerekir; DPO görüşü kayıt altına alınmalıdır." }
        ]},
        { heading: "🔄 Sorumlu İnovasyon", concepts: [
          ...
          { title: "Stilgoe'nin 4 Boyutu", text: "Öngörü (Anticipation), Özdüşünüm (Reflexivity), Katılım (Inclusion), Duyarlılık (Responsiveness)." },
          { title: "Von Schomberg", text: "Sorumlu inovasyon: etik olarak kabul edilebilir, toplumsal olarak arzu edilir ve sürdürülebilir olmalıdır." },
          { title: "AREA", text: "Anticipate, Reflect, Engage, Act: yöntemi pratikte çalıştıran operasyonel çerçevedir." }
        ]},
        { heading: "📐 Değerler-Normlar-Kurallar (VNR)", concepts: [
          { title: "Zincirin Mantığı", text: "Değerler soyut ilkeleri verir, normlar davranış beklentisine çevirir, kurallar uygulanabilir zorunluluk üretir." },
          { title: "Örnek Zincir", text: "Gizlilik -> kullanıcıyı bilgilendirme normu -> GDPR Madde 13 kuralı." }
        ]},
        { heading: "🗺️ NIST AI Risk Yönetimi", concepts: [
          { title: "MAP-MEASURE-MANAGE-GOVERN", text: "Bağlamı ve riskleri haritala, riskleri ölç, aksiyon alarak yönet, kurumsal yönetişim ile sürekliliği sağla." }
        ]}
      ]
    },
    flashcards: [
      ...
      { term: "DPIA 7 Steps", definition: "1) Identify the need 2) Describe the processing 3) Consultation with stakeholders 4) Assess necessity & proportionality 5) Assess risks 6) Identify mitigation measures 7) Sign off & ongoing review. NOT a one-time exercise!", definitionTR: "1) İhtiyacı belirle 2) İşlemeyi tanımla 3) Paydaşlarla danış 4) Gerekliliği değerlendir 5) Riskleri değerlendir 6) Azaltma önlemleri belirle 7) Onay ve sürekli gözden geçirme." },
      ...
      { term: "DPIA Risk Matrix", definition: "DPIA Step 5 evaluates risks by LIKELIHOOD and SEVERITY, then prioritizes mitigation based on overall risk.", definitionTR: "DPIA 5. adımda riskler OLASILIK ve ETKİ ŞİDDETİ ile değerlendirilir; toplam riske göre önlem önceliği verilir." },
      { term: "Residual High Risk Consultation", definition: "If high residual risk remains after mitigation, prior consultation with the supervisory authority is required before processing continues.", definitionTR: "Azaltma sonrası yüksek artık risk kalırsa işlemeye devam etmeden önce denetim otoritesiyle ön danışma gerekir." },
      ...
      { term: "Von Schomberg’s RRI Definition", definition: "Innovation must be: (1) ETHICALLY ACCEPTABLE, (2) SOCIALLY DESIRABLE, (3) SUSTAINABLE. This is the benchmark definition used in EU policy for Responsible Innovation.", definitionTR: "İnovasyon: (1) ETİK OLARAK KABUL EDİLEBİLİR, (2) TOPLUMSAL OLARAK ARZU EDİLİR, (3) SÜRDÜRÜLEBİLİR olmalıdır." },
      { term: "Stilgoe’s 4 Dimensions of RI", definition: "ANTICIPATION (horizon scanning, scenarios), REFLEXIVITY (examine own biases), INCLUSION (engage stakeholders early), RESPONSIVENESS (willingness to change direction).", definitionTR: "ÖNGÖRÜ (ufuk taraması), ÖZDÜŞÜNÜM (önyargıları sorgula), KATILIM (paydaşları erken dahil et), DUYARLILIK (yön değiştirme istekliliği)." },
      { term: "NIST AI Risk Framework", definition: "4 functions: MAP (identify context & risks), MEASURE (assess & analyze risks), MANAGE (prioritize & act), GOVERN (create risk-aware culture, policies, monitoring).", definitionTR: "4 fonksiyon: HARİTALA (bağlam ve riskleri belirle), ÖLÇ (riskleri değerlendir), YÖNET (önceliklendir ve harekete geç), YÖNETİŞİM (risk farkındalığı kültürü oluştur)." },
      { term: "VNR Chain — Privacy Example", definition: "Value: Privacy → Norm: Users must be informed about data collection → Rule: GDPR Article 13 (right to be informed).", definitionTR: "Değer: Gizlilik → Norm: Kullanıcılar veri toplama hakkında bilgilendirilmeli → Kural: GDPR Madde 13." },
      { term: "VNR Chain — Accountability", definition: "Value: Accountability → Norm: Traceability / logging of decisions → Rule: ISO/IEC 25010 (software quality standard).", definitionTR: "Değer: Hesap Verebilirlik → Norm: İzlenebilirlik / karar kaydı → Kural: ISO/IEC 25010." },
      { term: "VNR Chain — Safety", definition: "Value: Safety → Norm: Conduct risk assessment → Rule: AI Act Article 9 (risk management system for high-risk AI).", definitionTR: "Değer: Güvenlik → Norm: Risk değerlendirmesi yap → Kural: AI Act Madde 9 (yüksek riskli AI için risk yönetimi)." },
      { term: "Ethics as Design Constraint", definition: "Ethics is an INPUT to development, not an afterthought. It must SHAPE the system DURING design, not be checked at the end.", definitionTR: "Etik geliştirmeye bir GİRDİdir, sonradan eklenen bir şey değil. Tasarım SIRASINDA sistemi şekillendirmelidir." }
    ],
    quiz: [
      ...
      { q: "Von Schomberg defines Responsible Innovation as innovation that is:", options: ["Fast, cheap, and scalable", "Ethically acceptable, socially desirable, and sustainable", "Profitable, innovative, and disruptive", "Open-source, transparent, and free"], correct: 1, explanation: "Von Schomberg’s definition: innovation must be ETHICALLY ACCEPTABLE, SOCIALLY DESIRABLE, and SUSTAINABLE. This is the benchmark used in EU policy." },
      { q: "In Stilgoe’s framework, 'Reflexivity' means:", options: ["Making the AI reflexive to inputs", "Examining your own biases, motivations, and the limits of your knowledge", "Reflecting light from screens", "Creating a feedback loop in the algorithm"], correct: 1, explanation: "Reflexivity = looking inward at your own motivations, biases, and embedded values. Being aware of what you DON'T know." },
      { q: "The DPIA process has how many steps in its full form?", options: ["3", "4", "5", "7"], correct: 3, explanation: "Full DPIA: (1) Identify need, (2) Describe processing, (3) Consultation, (4) Assess necessity, (5) Assess risks, (6) Identify measures, (7) Sign off & ongoing review." },
      { q: "In the VNR chain, the Value 'Safety' maps to which Rule?", options: ["GDPR Article 13", "AI Act Article 9 (Risk Management)", "ISO/IEC 25010", "GDPR Article 35"], correct: 1, explanation: "Safety → Norm: Risk Assessment → Rule: AI Act Article 9, which requires a risk management system for high-risk AI systems." },
      { q: "The NIST AI Risk Framework function 'GOVERN' means:", options: ["Government regulation of AI", "Creating a risk-aware organizational culture with policies and accountability", "Governing data access permissions", "Government oversight of patents"], correct: 1, explanation: "GOVERN = creating a risk-aware culture, establishing policies, accountability structures, and continuous monitoring within the organization." },
      { q: "In a DPIA, if mitigation measures are applied but HIGH residual risk still remains, what should happen next?", options: ["Proceed immediately if management approves", "Delete all data and restart the project", "Consult the supervisory authority before continuing processing", "Replace DPIA with a security audit only"], correct: 2, explanation: "If high residual risk remains, prior consultation with the supervisory authority is required before going ahead with the processing." },
      { q: "Why is DPIA described as 'NOT a one-time exercise'?", options: ["Because it's too expensive to do once", "Because risks change over time and ongoing review is needed", "Because regulators require monthly reports", "Because technology never works the first time"], correct: 1, explanation: "DPIA requires ongoing review because risks evolve as technology, data, and context change. Step 7 explicitly requires sign-off AND planned ongoing review." }
    ],
    terms: [
      ...
      { term: "Von Schomberg", def: "RRI = Ethically Acceptable + Socially Desirable + Sustainable. EU policy benchmark.", defTR: "RRI = Etik Kabul Edilebilir + Toplumsal Arzu Edilir + Sürdürülebilir. AB politika ölçütü.", importance: "high" },
      { term: "Stilgoe 4 Dims", def: "Anticipation, Reflexivity, Inclusion, Responsiveness — framework for responsible innovation.", defTR: "Öngörü, Özdüşünüm, Katılım, Duyarlılık — sorumlu inovasyon çerçevesi.", importance: "high" },
      { term: "NIST RMF", def: "AI Risk Management: Map → Measure → Manage → Govern.", defTR: "AI Risk Yönetimi: Haritala → Ölç → Yönet → Yönetişim.", importance: "high" },
      { term: "DPIA 7 Steps", def: "Identify need, Describe, Consult, Necessity, Risks, Measures, Sign off — ongoing process.", defTR: "İhtiyacı belirle, Tanımla, Danış, Gereklilik, Riskler, Önlemler, Onay — sürekli süreç.", importance: "high" },
      { term: "Ethics as Input", def: "Ethics is a design constraint and INPUT to development, not an afterthought.", defTR: "Etik bir tasarım kısıtlaması ve geliştirmeye GİRDİdir, sonradan eklenmez.", importance: "high" },
      { term: "Pre-mortem Analysis", def: "Imagining the project has FAILED and working backwards to identify what went wrong.", defTR: "Projenin BAŞARISIZ olduğunu hayal edip geriye doğru neyin yanlış gittiğini belirleme.", importance: "medium" },
      { term: "Horizon Scanning", def: "Systematically looking for potential future impacts and threats of a technology.", defTR: "Bir teknolojinin potansiyel gelecek etkilerini ve tehditlerini sistematik olarak arama.", importance: "medium" }
    ]
  },
