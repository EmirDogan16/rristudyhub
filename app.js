...
const WEEKS = {
  ...
  3: {
    title: { en: "Week 3 — Data Protection & DPIA", tr: "Hafta 3 — Veri Koruma & DPIA" },
    subtitle: { en: "Privacy by Design, DPIA Process, Data Protection Principles", tr: "Tasarımdan Gizlilik, DPIA Süreci, Veri Koruma İlkeleri" },
    summary: {
      en: [
  ...
  4: {
    ...
    subtitle: { en: "Data Management, Fairness, and Algorithmic Bias", tr: "Veri Yönetimi, Adalet ve Algoritmik Yanlılık" },
    summary: {
      en: [
  ...
  6: {
    title: { en: "Week 6 — Privacy, Surveillance & Human Rights", tr: "Hafta 6 — Gizlilik, Gözetleme & İnsan Hakları" },
    subtitle: { en: "Panopticon, Surveillance Capitalism, Facial Recognition", tr: "Panoptikon, Gözetleme Kapitalizmi, Yüz Tanıma" },
    summary: {
      en: [
  ...
  7: {
    title: { en: "Week 7 — Human-Centric AI & Global Governance", tr: "Hafta 7 — İnsan Odaklı AI & Küresel Yönetişim" },
    subtitle: { en: "Human Oversight, UNESCO, Trustworthy AI", tr: "İnsan Denetimi, UNESCO, Güvenilir AI" },
    summary: {
      en: [
